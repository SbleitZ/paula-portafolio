...
const educacion = [
  {
    ...
    date:"2021 - 2023",
    description:"Comencé a estudiar Gráfica y Animación en la Universidad Nacional del Litoral. \nAprendí herramientas y técnicas de animación digital 2D y 3D."
  },
  {
    college:"Formación complementaria",
    date:"2021 - 2023",
    description:"Realicé cursos sobre Diseño UX/UI en PoloTic Misiones, CoderHouse, EducacionIT, más tutoriales de YouTube que tomaba de forma autodidacta.\n También tomé cursos de programación Frontend en Plataforma 5, aprendiendo HTML, CSS, Bootstrap y bases de JavaScript."
  },
  {
    college:"",
    date:"",
...
export default function MyEducation(){
  return (<section className="p-20 flex justify-center items-center flex-col gap-20">
    {
      educacion.map((props,i)=> <EducationBox key={i} {...props} />)
    }
  </section>);
}
...
function EducationBox({college,date,description}:EducationBoxProps){
  return (<article className="flex flex-col gap-10">
